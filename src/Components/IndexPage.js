...
export default class IndexPage extends Component {
    ...
    render() {
        return (
            <div className="container-fluid" style={{minHeight: "85vh",textAlign: "center", backgroundColor:"white" }}>
            <div style={{ backgroundColor: "rgb(255, 255, 255 )", color: "white", textAlign:"center" }}>
                ...
                <img className="fluid" style={{ width: "40%" }} src="./fondo.jpg" alt="Fenix - Corp - Computador" />
            </div>
            </div>
        )
    }
